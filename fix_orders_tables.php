...
echo "<h2>Sửa lại cấu trúc bảng orders và order_items</h2>";

// Xóa bảng cũ
$db->executeQuery("DROP TABLE IF EXISTS order_items");
$db->executeQuery("DROP TABLE IF EXISTS orders");

// Tạo lại bảng orders với cấu trúc đúng
...
if ($result_orders) {
    echo "✓ Đã tạo lại bảng orders thành công!<br>";
} else {
    echo "✗ Lỗi tạo bảng orders<br>";
}

// Tạo lại bảng order_items với cấu trúc đúng
...
if ($result_order_items) {
    echo "✓ Đã tạo lại bảng order_items thành công!<br>";
} else {
    echo "✗ Lỗi tạo bảng order_items<br>";
}

// Hiển thị cấu trúc bảng mới
echo "<h3>Cấu trúc bảng orders mới:</h3>";
...
echo "<h3>Cấu trúc bảng order_items mới:</h3>";
...
echo "<p style='color:green;font-weight:bold;'>Hoàn thành sửa lại cấu trúc bảng orders và order_items!</p>";
?> 