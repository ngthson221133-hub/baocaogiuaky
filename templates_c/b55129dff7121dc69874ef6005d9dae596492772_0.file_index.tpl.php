<?php
/* Smarty version 5.5.1, created on 2025-07-29 14:49:30
  from 'file:templates/checkout/index.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_6888c35a4963e1_60499128',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b55129dff7121dc69874ef6005d9dae596492772' => 
    array (
      0 => 'templates/checkout/index.tpl',
      1 => 1753785980,
      2 => 'file',
    ),
  ),
...
function content_6888c35a4963e1_60499128 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\itc_toi-main\\templates\\checkout';
$_smarty_tpl->getInheritance()->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_3857843246888c35a476c99_02478619', 'title');
?>

<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_21362077776888c35a47b479_07970373', 'content');
?>
 <?php $_smarty_tpl->getInheritance()->endChild($_smarty_tpl, "../layout_home.tpl", $_smarty_current_dir);
}
/* {block 'title'} */
class Block_3857843246888c35a476c99_02478619 extends \Smarty\Runtime\Block
{
...
/* {/block 'title'} */
/* {block 'content'} */
class Block_21362077776888c35a47b479_07970373 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\itc_toi-main\\templates\\checkout';
?>
...
" alt="<?php echo (($tmp = $_smarty_tpl->getValue('item')['name'] ?? null)===null||$tmp==='' ? $_smarty_tpl->getValue('item')['product_name'] ?? null : $tmp);?>
" style="width:100%;height:100%;object-fit:cover;border-radius:8px;" onerror="this.style.display='none';this.parentElement.innerHTML='<i class=\'fas fa-image\' style=\'font-size:24px;color:#9ca3af;\'></i>'">
                            <?php } else { ?>
                                <i class="fas fa-image" style="font-size:24px;color:#9ca3af;"></i>
                            <?php }?>
                        </div>
                        <div style="flex:1;min-width:0;">
                            <div style="font-weight:600;color:#1f2937;margin-bottom:4px;word-wrap:break-word;"><?php echo (($tmp = $_smarty_tpl->getValue('item')['name'] ?? null)===null||$tmp==='' ? $_smarty_tpl->getValue('item')['product_name'] ?? null : $tmp);?>
</div>
                            <div style="color:#6b7280;font-size:0.9em;">Số lượng: <?php echo $_smarty_tpl->getValue('item')['quantity'];?>
</div>
                        </div>
                        <div style="font-weight:600;color:#22c55e;flex-shrink:0;"><?php echo ($_smarty_tpl->getSmarty()->getModifierCallback('number_format')(($_smarty_tpl->getValue('item')['price']*$_smarty_tpl->getValue('item')['quantity']),0,",","."));?>
đ</div>
                    </div>
                    <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
            ...
            <div style="border-top:2px solid #f3f4f6;padding-top:20px;">
                <div style="display:flex;justify-content:space-between;align-items:center;font-size:1.2em;font-weight:600;color:#1f2937;">
                    <span>Tổng cộng:</span>
                    <span style="color:#22c55e;font-size:1.4em;"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('cart_total'),0,",",".");?>
đ</span>
                </div>
            </div>
...
function applyPromotion() {
    ...
    fetch('/itc_toi-main/index.php?controller=checkout&action=validatePromotion', {
        ...
        body: 'promotion_code=' + encodeURIComponent(code) + '&order_amount=' + <?php echo $_smarty_tpl->getValue('cart_total');?>
    ...
    .catch(error => {
       ...
       function removePromotion() {
           ...
           if (totalContainer) {
               totalContainer.innerHTML = '<div style="display:flex;justify-content:space-between;align-items:center;font-size:1.2em;font-weight:600;color:#1f2937;"><span>Tổng cộng:</span><span style="color:#22c55e;font-size:1.4em;"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('cart_total'),0,",",".");?>
đ</span></div>';
           }
       }
...
function updateOrderSummary(discountAmount) {
    ...
    const currentTotal = <?php echo $_smarty_tpl->getValue('cart_total');?>
;
