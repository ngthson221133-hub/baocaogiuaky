            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:30px;">
                <div>
                    <div style="margin-bottom:15px;">
                        ...
                        <span>{if $order.username}{$order.username}{else}{$order.guest_name}{/if}</span>
                    </div>
                    <div style="margin-bottom:15px;">
                        <span style="font-weight:600;color:#374151;">Email:</span>
                        <span>{if $order.user_email}{$order.user_email}{else}{$order.guest_email}{/if}</span>
                    </div>
                </div>
                <div>
                    <div style="margin-bottom:15px;">
        ...
        <div style="background:#fff;padding:30px;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1);height:fit-content;">
            ...
            <div style="margin-bottom:20px;">
                ...
                <select id="orderStatusSelect" style="width:100%;padding:12px;border:2px solid #e5e7eb;border-radius:8px;font-size:1em;">
                    ...
                    <option value="confirmed" {if $order.status == 'confirmed'}selected{/if}>Đã xác nhận</option>
                    <option value="shipped" {if $order.status == 'shipped'}selected{/if}>Đang giao</option>
