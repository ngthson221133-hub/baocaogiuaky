...
<head>
    <meta charset="UTF-8">
    <title>{block name=title}Trang chủ - Trái Cây Tươi{/block}</title>
...
<body style="background:#f8f8f8;min-height:100vh;">
    ...
    <div class="menu">
      ...
      <div class="menu-icons">
        ...
        {/if}
        {if isset($smarty.session.username)}
          <span style="color:#fff;font-weight:500;margin-right:12px;">Xin chào, {$smarty.session.username}</span>
